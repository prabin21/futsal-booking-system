    ...
    <div class="container-fluid">
        ...
        <div class="row col-lg-12 ">
             <div class="card-body  rounded cardboard">
                   ...
                   <h1 class="text-danger d-flex justify-content-center">Player/Team Register</h1>
                 ...
                 <br><br>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label for="dob" class="col-md-4 col-form-label text-md-right text-white font-weight-bold">{{ __('Date of Birth') }}</label>
